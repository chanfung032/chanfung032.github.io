# -*- coding: utf-8 -*-
#
# My Blog documentation build configuration file, created by
...
project = u'Feng\'s blog'
copyright = u'2017, chanfung032'
author = u'chanfung032'
...
latex_documents = [
  (master_doc, 'MyBlog.tex', u'My Blog Documentation',
   u'chanfung032', 'manual'),
]
...
man_pages = [
    (master_doc, 'myblog', u'My Blog Documentation',
     [author], 1)
]
